...
Q_CONSTINIT static const qt_meta_stringdata_CLASSClientHandlerENDCLASS_t qt_meta_stringdata_CLASSClientHandlerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 19),  // "sendRegDataToServer"
        QT_MOC_LITERAL(34, 0),  // ""
        QT_MOC_LITERAL(35, 4),  // "data"
        QT_MOC_LITERAL(40, 19),  // "sendLogDataToServer"
        QT_MOC_LITERAL(60, 5),  // "start"
        QT_MOC_LITERAL(66, 11),  // "sendMessage"
        QT_MOC_LITERAL(78, 7),  // "message"
        QT_MOC_LITERAL(86, 14),  // "readClientData"
...
Q_CONSTINIT const QMetaObject ClientHandler::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSClientHandlerENDCLASS_t,
        ...
        // method 'sendRegDataToServer'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QByteArray &, std::false_type>,
        // method 'sendLogDataToServer'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QByteArray &, std::false_type>,
        // method 'start'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendRegDataToServer((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->sendLogDataToServer((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 2: _t->start(); break;
        case 3: _t->sendMessage((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->readClientData(); break;
        ...
        {
            using _t = void (ClientHandler::*)(const QByteArray & );
            if (_t _q_method = &ClientHandler::sendRegDataToServer; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ClientHandler::*)(const QByteArray & );
            if (_t _q_method = &ClientHandler::sendLogDataToServer; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ClientHandler::sendRegDataToServer(const QByteArray & _t1)
{
...
// SIGNAL 1
void ClientHandler::sendLogDataToServer(const QByteArray & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
